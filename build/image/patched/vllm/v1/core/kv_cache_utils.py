...
def update_kv_cache_capacity(
    ...
    # Record exact group accounting for offline capacity calibration.
    from dsv41_capacity import record_capacity

    record_capacity(vllm_config, kv_cache_config, num_tokens, max_concurrency)
    max_model_len = vllm_config.model_config.max_model_len
    logger.info_once(
