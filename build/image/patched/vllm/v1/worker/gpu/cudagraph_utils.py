...
class CudaGraphManager:
    ...
    def capture(
        ...
        from dsv41_capacity import record_graph_capture

        record_graph_capture(self, progress_bar_desc)
    ...
    def run_fullgraph(self, desc: BatchExecutionDescriptor):
        ...
        from dsv41_capacity import record_graph_replay

        record_graph_replay(self, desc)
